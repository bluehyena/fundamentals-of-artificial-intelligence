...
class BasicBlock(nn.Module):
    ...
    def __init__(self, in_channels: int, out_channels: int, stride: int = 1) -> None:
        ...
        if stride != 1 or in_channels != out_channels * self.expansion_factor:
            self.residual = nn.Sequential(
                nn.Conv2d(in_channels=in_channels, out_channels=out_channels * self.expansion_factor, kernel_size=1, stride=stride, bias=False),
...
class BottleNeck(nn.Module):
    ...
    def __init__(self, in_channels: int, out_channels: int, stride: int = 1):
        ...
        self.conv3 = nn.Conv2d(in_channels=out_channels, out_channels=out_channels * self.expansion_factor, kernel_size=1, stride=1, bias=False)
